 ...
 * Benchmark: rosetta-3d-rendering
 * Upstream: cornell-zhang/rosetta @ 2feed1ce02d871603bf1fc344a65051837ac780f
...
/* ===== BEGIN UPSTREAM FILE: 3d-rendering/src/ocl/rendering.cpp ===== */
/*===============================================================*/
/*                                                               */
/*                        rendering.cpp                          */
/*                                                               */
...
/* ===== BEGIN UPSTREAM FILE: 3d-rendering/src/host/typedefs.h ===== */
/*===============================================================*/
/*                                                               */
/*                          typedefs.h                           */
/*                                                               */
...
/* ===== END UPSTREAM FILE: 3d-rendering/src/host/typedefs.h ===== */
...
{
/* MailoHLS: removed pre-existing HLS optimization pragma */
...
/* MailoHLS: removed pre-existing HLS optimization pragma */
  ...
  /*L1:*/ static bit8 z_buffer[MAX_X][MAX_Y];
  #pragma HLS array_partition variable=z_buffer type=auto{_ARRAY_T_L1} factor=auto{_ARRAY_F_L1} dim=auto{_ARRAY_D_L1}
  if (counter == 0)
  {
    /*L2:*/ ZCULLING_INIT_ROW: for ( bit16 i = 0; i < MAX_X; i++)
    #pragma HLS pipeline II=auto{_PIPE_L2}
    #pragma HLS unroll factor=auto{_UNROLL_L2}
    {
/* MailoHLS: removed pre-existing HLS optimization pragma */
      /*L3:*/ ZCULLING_INIT_COL: for ( bit16 j = 0; j < MAX_Y; j++)
...
/* MailoHLS: removed pre-existing HLS optimization pragma */
  ...
  if ( counter == 0 )
  {
    ...
    /*L4:*/ COLORING_FB_INIT_ROW: for ( bit16 i = 0; i < MAX_X; i++)
    #pragma HLS pipeline II=auto{_PIPE_L4}
    #pragma HLS unroll factor=auto{_UNROLL_L4}
    {
/* MailoHLS: removed pre-existing HLS optimization pragma */
      /*L5:*/ COLORING_FB_INIT_COL: for ( bit16 j = 0; j < MAX_Y; j++)
...
/* MailoHLS: removed pre-existing HLS optimization pragma */
  bit32 out_FB = 0;
  /*L6:*/ OUTPUT_FB_ROW: for ( bit16 i = 0; i < MAX_X; i++)
  #pragma HLS pipeline II=auto{_PIPE_L6}
  #pragma HLS unroll factor=auto{_UNROLL_L6}
  {
/* MailoHLS: removed pre-existing HLS optimization pragma */
    /*L7:*/ OUTPUT_FB_COL: for ( bit16 j = 0; j < MAX_Y; j = j + 4)
...
extern "C" 
{
  void rendering( bit32 input[3*NUM_3D_TRI], bit32 output[NUM_FB])
  {
    ...
    bit16 size_fragment;
    /*L8:*/ CandidatePixel fragment[500];
    #pragma HLS array_partition variable=fragment type=auto{_ARRAY_T_L8} factor=auto{_ARRAY_F_L8} dim=auto{_ARRAY_D_L8}
  
    bit16 size_pixels;
    /*L9:*/ Pixel pixels[500];
    #pragma HLS array_partition variable=pixels type=auto{_ARRAY_T_L9} factor=auto{_ARRAY_F_L9} dim=auto{_ARRAY_D_L9}
  
    /*L10:*/ bit8 frame_buffer[MAX_X][MAX_Y];
    #pragma HLS array_partition variable=frame_buffer type=auto{_ARRAY_T_L10} factor=auto{_ARRAY_F_L10} dim=auto{_ARRAY_D_L10}
    bit2 angle = 0;
  
    /*L11:*/ bit8 max_min[5];
    #pragma HLS array_partition variable=max_min type=auto{_ARRAY_T_L11} factor=auto{_ARRAY_F_L11} dim=auto{_ARRAY_D_L11}
    bit16 max_index[1];
    bit2 flag;
  
    // processing NUM_3D_TRI 3D triangles
    /*L12:*/ TRIANGLES: for (bit16 i = 0; i < NUM_3D_TRI; i++)
...
/* ===== END UPSTREAM FILE: 3d-rendering/src/ocl/rendering.cpp ===== */
