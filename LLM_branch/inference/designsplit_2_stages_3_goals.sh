...
RUN_ROOT="/home/ubuntu/runs/random_design_split_${STAMP}"
...
COMMON_ARGS=(
  ...
  --save_steps 164
  --stage2_epochs 4
  --stage2_eval_steps 164
  --stage2_save_steps 164
