...
RUN_ROOT="/home/ubuntu/runs/serrano_holdout_${STAMP}"
SPLIT_JSON="${RUN_ROOT}/splits/family_holdout_serrano.json"
...
COMMON_ARGS=(
  ...
  # -------------------------
  --split_mode family
  --val_families "rodinia_pathfinder;machsuite_sort_radix"
  --test_families "serrano_kalman_filter"
  ...
  --save_steps 150
  --stage2_epochs 4
  --stage2_eval_steps 100
  --stage2_save_steps 100
...
echo
echo "===================================================================================================="
echo "[DONE] Serrano family-holdout run finished"
echo "[ROOT] ${RUN_ROOT}"
