...
L1:    float w0_buf[16];
L2:    float oldw0_buf[16];

L3:    float delta_buf[16];

L4:    float ly_buf[65536];

L5:    float w_buf[TILE_SIZE][16];
L6:    float oldw_buf[TILE_SIZE][16];
...
L7:    LOOP1: for (kk = 1; kk < 65537; kk+=TILE_SIZE) {
