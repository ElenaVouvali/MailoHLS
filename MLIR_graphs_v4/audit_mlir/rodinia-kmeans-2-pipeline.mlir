...
#loc83 = loc("kmeans.cpp":32:10)
#loc84 = loc("kmeans.cpp":31:22)
#loc85 = loc("kmeans.cpp":28:9)
#loc86 = loc("kmeans.cpp":27:6)
                ...
                ^bb2:  // pred: ^bb1
                  %9:6 = scf.if %true -> (f32, i32, f32, i32, i32, f32) {
                    %10:6 = scf.execute_region -> (f32, i32, f32, i32, i32, f32) {
                      ...
                      ^bb0(%arg10: f32 loc("kmeans.cpp":35:17), %arg11: i32 loc("kmeans.cpp":34:27), %arg12: f32 loc("kmeans.cpp":32:10), %arg13: i32 loc("kmeans.cpp":31:22), %arg14: i32 loc("kmeans.cpp":28:9), %arg15: f32 loc("kmeans.cpp":27:6)):
                        %13 = scf.if %true -> (f32) {
                          ...
                          ^bb2:  // pred: ^bb1
                            %18:3 = scf.if %true -> (f32, i32, f32) {
                              %19:3 = scf.execute_region -> (f32, i32, f32) {
                                ...
                                ^bb0(%arg16: f32 loc("kmeans.cpp":35:17), %arg17: i32 loc("kmeans.cpp":34:27), %arg18: f32 loc("kmeans.cpp":32:10)):
                                  %22 = scf.if %true -> (f32) {
